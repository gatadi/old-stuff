...
public class CNewProxy implements Runnable
{
        ...
        throws Exception
    {
        ...
        while (true) 
        {
            ...
            new Thread(new CNewProxy(cin, rout, ">>>", id)).start();
            new Thread(new CNewProxy(rin, cout, "<<<", -id)).start();
            id++;
        }
    }

    CNewProxy(InputStream in, OutputStream out,
           String pfx, int id)
    {
        m_in = in;
        m_out = out;
